...
uses OpenJDK 21 in the managed Lavalink configuration. It can be installed by running:

.. code-block:: sh

    sudo apt install openjdk-21-jre-headless -y

Otherwise, Lavalink works well with most versions of Java though recommends usage of LTS versions such as 21 and 17. Azul 
...
The current supported versions are Java 21 and 17.
